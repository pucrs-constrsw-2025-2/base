...
A arquitetura do projeto é estritamente baseada no padrão **Ports & Adapters (Arquitetura Hexagonal)**. Essa abordagem garante um forte desacoplamento entre a lógica de negócio principal (o *core* da aplicação) e as tecnologias externas, como o framework web e o cliente HTTP para o Keycloak.
